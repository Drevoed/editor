...
import { BlockMenuContent, useControlsState, } from '../../left-controls';
import { PRISM_LANGUAGES } from '../constants';
import { Transforms } from 'slate';
import styled from 'solid-styled-components';
import "solid-js/store";
export const CodeControls = (props) => {
...
const Content = ({ hide }) => {
    ...
    if (element.type !== 'code')
        return null;
    return (<BlockMenuContent.Section name="Select code language">
      ...
      <BlockMenuContent.List style={{ maxHeight: 200, overflow: 'auto' }}>
        {matchedLanguages.map((language) => {
            ...
            return (<BlockMenuContent.Item key={language.name} name={language.name} onClick={() => setLanguage(language.grammarName)} style={{ color: isSelected ? 'rgb(56, 132, 255)' : '' }}/>);
        })}
...
`;
export const searchIcon = (<svg preserveAspectRatio="xMidYMid meet" height="1em" width="1em" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor" className="icon-7f6730be--text-3f89f380">
    <g>
