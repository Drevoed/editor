...
export const AddMenu = (props) => (<MenuWrapper svg={PlusSvg} iconClassName="plus" content={AddMenuContent} {...props}/>);
const PlusSvg = (props) => (<svg preserveAspectRatio="xMidYMid meet" height="1em" width="1em" fill="none" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" stroke="currentColor" {...props}>
    <g>
      <line x1="12" y1="5" x2="12" y2="19"/>
      <line x1="5" y1="12" x2="19" y2="12"/>
    </g>
  </svg>);
const AddMenuContent = ({ hide }) => {
    ...
    const variants = useMemo(() => {
        return SettingsRegistry.getAll()
            ...
            .map(({ type, name, code }) => {
            return (<BlockMenuContent.Item key={type} name={name} detail={`/${code}`} onClick={() => add(type)}/>);
        });
    }, []);
...
//# sourceMappingURL=add.menu.jsx.map